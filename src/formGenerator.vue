		...
		fieldset(:is='tag', :class='getFieldRowClasses(group)')
			...
			b-collapse(class="mt-2"  v-model="showCollapse[key]" :id="'collapse'+key")
				template(v-for='field in group.fields')
					form-group(v-if='fieldVisible(field) && !showAlways(field)', :vfg="vfg", :field="field", :errors="errors", :model="model", :options="options", @validated="onFieldValidated", @model-updated="onModelUpdated")
